...
mesaver="https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-24.2.3/mesa-mesa-24.2.3.zip"
mesadir="mesa-mesa-24.2.3"
...
META_FILE="meta.json"
ZIP_FILE="Turnip-24.2.3-EMULATOR.zip"
...
zip -r $workdir/Turnip-24.2.3-MAGISK-KSU.zip * &> /dev/null
if ! [ -a $workdir/Turnip-24.2.3-MAGISK-KSU.zip ]; then
...
{
  "schemaVersion": 1,
  "name": "Freedreno Turnip Driver v24.2.3",
  "description": "Compiled using Android NDK 27B + Mesa 24.2.3",
  "author": "v3kt0r-87",
  "packageVersion": "3",
  "vendor": "Mesa3D",
